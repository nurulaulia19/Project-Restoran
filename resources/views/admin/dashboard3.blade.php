...
<!-- Mirrored from www.themeon.net/nifty/v2.9/dashboard-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Mar 2018 05:38:22 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--Morris.js [ OPTIONAL ]-->
    <link href="{{ asset('assets/css/themes/type-d/theme-navy.min.css') }}" rel="stylesheet">
					                        ...
					                        <div class="nano" style="height:360px">
					                            <div class="nano-content">
					                                ...
					                                <div class="panel-body bord-btm">
					                                     ...
					                                     <div class="task-img">
					                                         <img class="img-responsive" src="{{ asset('assets/img/shared-img-2.jpg') }}" alt="Image">
					                                     </div>
					                                ...
					                                <div class="panel-body bord-btm">
					                                     ...
					                                     <a href="#" class="task-footer">
					                                         <span class="box-inline">
					                                             <img class="img-xs img-circle" src="{{ asset('assets/img/profile-photos/8.png') }}" alt="task-user">
					                                             Brenda Fuller
					                                         </span>
					                                     </a>
					                                 </div>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
											...
											<li><a href="/admin/dashboard2">Dashboard 2</a></li>
											<li class="active-link"><a href="/admin/dashboard3">Dashboard 3</a></li>
...
<!-- Mirrored from www.themeon.net/nifty/v2.9/dashboard-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Mar 2018 05:38:27 GMT -->
</html>
