...
<!-- Mirrored from www.themeon.net/nifty/v2.9/dashboard-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Mar 2018 05:38:16 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <script src="{{ asset('assets/plugins/pace/pace.min.jss') }}"></script>
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a href="/auth/login"><i class="demo-pli-unlock icon-lg icon-fw"></i> Logout</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
					            ...
					            <div class="col-sm-6 col-lg-12">
					                ...
					                <div class="panel">
					                    <div class="panel-body text-center">
					                        <img alt="Profile Picture" class="img-lg img-circle mar-btm" src="{{ asset('assets/img/profile-photos/5.png') }}">
					                    ...
					                    <table class="table table-vcenter mar-top">
					                        ...
					                        <tbody>
					                            <tr>
					                                ...
					                                <td><img src="{{ asset('assets/img/profile-photos/1.png') }}" alt="Profile Picture" class="img-circle img-sm"></td>
					                            ...
					                            <tr>
					                                ...
					                                <td><img src="{{ asset('assets/img/profile-photos/2.png') }}" alt="Profile Picture" class="img-circle img-sm"></td>
					                            ...
					                            <tr>
					                                ...
					                                <td><img src="{{ asset('assets/img/profile-photos/3.png') }}" alt="Profile Picture" class="img-circle img-sm"></td>
					                            ...
					                            <tr>
					                                ...
					                                <td><img src="{{ asset('assets/img/profile-photos/4.png') }}" alt="Profile Picture" class="img-circle img-sm"></td>
					                            ...
					                            <tr>
					                                ...
					                                <td><img src="{{ asset('assets/img/profile-photos/5.png') }}" alt="Profile Picture" class="img-circle img-sm"></td>
					                            ...
					                            <tr>
					                                ...
					                                <td><img src="{{ asset('assets/img/profile-photos/6.png') }}" alt="Profile Picture" class="img-circle img-sm"></td>
                                ...
                                <ul id="mainnav-menu" class="list-group">
						            ...
						            <li class="active-sub">
						                ...
						                <ul class="collapse in">
						                    <li><a href="home">Dashboard 1</a></li>
											<li class="active-link"><a href="/admin/dashboard2">Dashboard 2</a></li>
...
<!-- Mirrored from www.themeon.net/nifty/v2.9/dashboard-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Mar 2018 05:38:22 GMT -->
</html>
