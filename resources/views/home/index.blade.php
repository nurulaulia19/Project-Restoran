					    ...
					    <div class="row">
					        ...
					        <div class="col-md-3">
					            <div class="panel panel-info panel-colorful media middle pad-all">
					                ...
					                <div class="media-body">
					                    <p class="text-2x mar-no text-semibold">{{ $jumlahProduk }}</p>
					                    <p class="mar-no">Produk</p>
					                </div>
					            </div>
					        </div>
					        <div class="col-md-3">
					        ...
					        <div class="col-md-3">
					            <div class="panel panel-danger panel-colorful media middle pad-all">
					                <div class="media-left">
					                    <div class="pad-hor">
					                        <i class="fas fa-folder icon-3x"></i>
					                    </div>
					                </div>
					                <div class="media-body">
					                    <p class="text-2x mar-no text-semibold">{{ $jumlahAditional }}</p>
					                    <p class="mar-no">Aditional Produk</p>
					                </div>
					            </div>
					        </div>
							<div class="col-md-3">
